...
public class EntityAINearestAttackableTargetSmart extends EntityAINearestAttackableTarget
{
    ...
    public EntityAINearestAttackableTargetSmart(EntityLiving par1EntityLiving, Class par2Class, float par3, int par4, boolean par5)
    {
        this(par1EntityLiving, par2Class, par3, par4, par5, false);
    }

    public EntityAINearestAttackableTargetSmart(EntityLiving par1EntityLiving, Class par2Class, float par3, int par4, boolean par5, boolean par6)
    {
